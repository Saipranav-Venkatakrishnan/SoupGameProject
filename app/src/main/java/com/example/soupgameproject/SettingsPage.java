...
//                    if(randomSong == 0){
//                        mediaPlayer = MediaPlayer.create(MainActivity.this, R.raw.bornforthis);
//                        mediaPlayer.start();
//                    }
//                    else if(randomSong == 1){
//                        mediaPlayer = MediaPlayer.create(MainActivity.this, R.raw.glitterandgold);
//                        mediaPlayer.start();
//                    }
//                    else if(randomSong == 2){
//                        mediaPlayer = MediaPlayer.create(MainActivity.this, R.raw.legends);
//                        mediaPlayer.start();
//                    }
//                    else if(randomSong == 3){
//                        mediaPlayer = MediaPlayer.create(MainActivity.this, R.raw.sinners);
//                        mediaPlayer.start();
//                    }
//                    else if(randomSong == 4){
//                        mediaPlayer = MediaPlayer.create(MainActivity.this, R.raw.unstoppable);
//                        mediaPlayer.start();
//                    }
//                    else if(randomSong == 5){
//                        mediaPlayer = MediaPlayer.create(MainActivity.this, R.raw.kirbythemesong);
//                        mediaPlayer.start();
//                    }
//                }
//            });
